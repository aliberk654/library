...
local function generateCode()
    local digits = {"Q","W","E","R","T","Y","U","I","O","P","Ğ","Ü","A","S","D","F","G","H","J","K","L","Ş","İ",",","<","Z","X","V","B","N","M","Ö","Ç",".","1","2","3","4","5","6","7","8","9","0","?",")","(","]","[","{","}","=","_","&","+","%","$","'","£","!","½","a","b","c","d","h","j","n","c","l","ğ","ü","e","u","b","k","r","ب","ت","ث","ج","ح","خ","د","ذ","ر","ز","س","ش","ص","ء","ض","ط","ظ","ع","غ","ف","ق","ك","ل","م","ن","ه","و","ي","ﻫ","ﺴ","ぁ","あ","か","ゑ","イ","ポ","い","グ","㍿","🍜","🗾","🔰","🥷","👺","👹","🎴","🎏"}
	local code = {}

    local randomEndNumber = math.random(4,36)


    
    for i = 0, randomEndNumber, 1 do
        local randomDigit = digits[math.random(0,#digits)]

        table.insert(code, randomDigit)
    end
...
task.spawn(function()
    while wait(0.1) do
        ...
        ScreenGui.Name = newCode

        for i,v in pairs(ScreenGui:GetDescendants()) do
            local newCode2 = generateCode()
            v.Name = newCode2
        end
    end
end)
